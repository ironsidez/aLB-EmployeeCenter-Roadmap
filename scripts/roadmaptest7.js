...
*/
    ...
    while (counterProject < projectCount && activeProjects.length < projectsToDisplay + index) {
        displayedProj = 0;
   ...
   if(activeProjects.length >= projectsToDisplay + index){
      counterProject = index;
      //delete portion of array before counterProject
      //if remaining array length is greater than projectsToDisplay delete all items after it.
   }
   else{
      counterProject = activeProjects.length - projectsToDisplay;
      //delete portion of array before counterProject
   }
   ...
   while(counterProject < activeProjects.length || counterActive < projectsToDisplay){
...
function update() {
    createProjectgantt(jsonData.projectJson, jsonData.projectCount, $('select.projectCount').val());
}
