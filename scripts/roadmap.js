...
function createProjectgantt(x, y) {
   ...
   while (counterProject < projectCount) {
      ...
      if (projectJson.projects[counterProject].start && projectJson.projects[counterProject].end && projectJson.projects[counterProject].leader) {
         ...
         //Find the latest date by comparing the date from the current activeProject to our current latest date.
         ...
         if (projectJson.projects[counterProject].completionDate && Date.parse(projectJson.projects[counterProject].completionDate) > dateVar) {
