...
*/
    ...
    while (counterProject < projectCount && activeProjects.length < projectsToDisplay) {
        displayedProj = 0;
    ...
    //check if activeProjects has reached desired size yet, if so stop.
